...
class FamousPictureAdapter(val famousPicture : List<CloutLocationModel>) : RecyclerView.Adapter<FamousPictureAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val cloutLocation = famousPicture[position]
